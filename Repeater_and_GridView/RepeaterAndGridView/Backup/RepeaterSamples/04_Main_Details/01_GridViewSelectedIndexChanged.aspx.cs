...
{
    public partial class _01_GridViewSample : System.Web.UI.Page
    {
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Label1.Text = "Регионы, за которые отвечает сотрудник " + firstName + " " + lastName +
            " (employee ID " + ID.ToString() + "):";

            NorthwindDataSource2.SelectParameters["EmployeeID"].DefaultValue = ID.ToString();
        }
    }
}