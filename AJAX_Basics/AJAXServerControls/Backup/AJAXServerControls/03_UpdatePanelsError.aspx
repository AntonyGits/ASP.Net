...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function pageLoad() {
            ...
            // Событие endRequest происходит по завершению каждой асинхронной отправки.
        ...
        // В таком случае некоторые браузеры не будут отображать сообщения об ошибке на странице.
